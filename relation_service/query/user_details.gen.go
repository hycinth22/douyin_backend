...
type IUserDetailDo interface {
	...
	Create(values ...*model.UserDetail) error
	CreateInBatches(values []*model.UserDetail, batchSize int) error
	Save(values ...*model.UserDetail) error
	First() (*model.UserDetail, error)
	Take() (*model.UserDetail, error)
	Last() (*model.UserDetail, error)
	Find() ([]*model.UserDetail, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.UserDetail, err error)
	FindInBatches(result *[]*model.UserDetail, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.UserDetail) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.UserDetail, error)
	FirstOrCreate() (*model.UserDetail, error)
	FindByPage(offset int, limit int) (result []*model.UserDetail, count int64, err error)
